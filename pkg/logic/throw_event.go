...
// ThrowEventSatisfier is an algorithm that allows to apply events to a schema.ThrowEventInterface element
// and get a determination whether all conditions were satisfied.
type ThrowEventSatisfier struct {
	schema.ThrowEventInterface
	eventDefinitionInstances []event.IDefinitionInstance
	len                      uint
	chains                   []*bitset.BitSet
}

func (satisfier *ThrowEventSatisfier) EventDefinitionInstances() *[]event.IDefinitionInstance {
	return &satisfier.eventDefinitionInstances
}

func NewThrowEventSatisfier(catchEventElement schema.ThrowEventInterface, eventDefinitionInstanceBuilder event.IDefinitionInstanceBuilder) *ThrowEventSatisfier {
	satisfier := &ThrowEventSatisfier{
		ThrowEventInterface: catchEventElement,
...
// Satisfy matches an event against event definitions in ThrowEvent element,
...
// synchronization.
func (satisfier *ThrowEventSatisfier) Satisfy(ev event.IEvent) (matched bool, chain int) {
